                ...
                return o(t, e), t.prototype.start = function() {}, t.prototype.update = function(e) {}, t.prototype.onCollisionEnter = function(e, t) {
                    if ("bazi" == e.node.group) {
                        ...
                        if (a.default.tuoweiCtrl = !1, a.default.playerTouch = !0, e.node.stopAllActions(), t.node.children[2].getComponent(cc.ParticleSystem).stopSystem(), i.default.Instance.ribbonEffect(t.node.position, e.node, !0), e.node.removeComponent(cc.PolygonCollider), t.node.stopAllActions(), a.default.knifeLR = t.node.x > 0 ? 1 : -1, t.node.children[1].scaleX = -a.default.knifeLR, this.great(t.node, e.node), i.default.Instance.CameraAoto(), i.default.Instance.CreateBazi(a.default.knifeLR), -1 == a.default.knifeLR)
                            (n = r.default.Spawn("arrowL", this.node.parent)).position = this.node.position, u.default.Instance.Arrow = n, n.active = !0, n.angle = -45, n.position = this.node.position, n.runAction(cc.repeatForever(cc.sequence(cc.rotateBy(.8, -50), cc.rotateBy(1.6, 100), cc.rotateBy(.8, -50)))), t.node.runAction(cc.sequence(cc.moveBy(.05, -20, 0), cc.moveBy(.05, 20, 0))), e.node.runAction(cc.sequence(cc.moveBy(.05, -20, 0), cc.moveBy(.05, 20, 0)));
                        else
                            (n = r.default.Spawn("arrowR", this.node.parent)).position = this.node.position, u.default.Instance.Arrow = n, n.active = !0, n.angle = 45, n.position = this.node.position, n.runAction(cc.repeatForever(cc.sequence(cc.rotateBy(.8, -50), cc.rotateBy(1.6, 100), cc.rotateBy(.8, -50)))), t.node.runAction(cc.sequence(cc.moveBy(.05, 20, 0), cc.moveBy(.05, -20, 0))), e.node.runAction(cc.sequence(cc.moveBy(.05, 20, 0), cc.moveBy(.05, -20, 0)));
        ...
        var o = e("HttpManagerJs"),
            ...
            r = (e("GameUiTools"), {
                ...
                getHttpGameId: function() {
                    ...
                    this.gameAllHttp = o, cc.log("gameAll", this.gameAllHttp), this.subScoreHttp = "http://g.vsane.com/Service/Score/index", this.gamePvHttp = "http://g.vsane.com/Service/GamePv/index";
                    var c = document.URL,
                        a = c.lastIndexOf("/"),
                        i = c.substring(0, a),
    ...
    Utils: [function(e, t, n) {
        ...
        var o = function() {
            ...
            return e.getBezierPos = function(e, t) {
                ...
                //debug return Math.floor(Math.random() * (t - e) + e)
                ...
                for (c = 0; c < t.length; c++)
                    0 != c && (a += e), t[c].x = a + .5 * t[c].width, a += t[c].width
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
                        ...
                        c == r && c < 9 && r < 9 ? (this.pengzhuangCount += 1, 0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += (this.fruitNumber + 1)*10, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(t.node).to(.1, {
                            ...
                            //debug
                            i.default.Instance.createFruitSui(o.fruitNumber, n.node.position), i.default.Instance.createFruitL(o.fruitNumber, n.node.position, n.node.width), i.default.Instance.createLevelUpFruit(0, n.node.position);
